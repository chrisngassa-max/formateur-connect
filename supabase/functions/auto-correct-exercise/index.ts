...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // answers: Array<{ item_index: number; reponse: string | number }>

    // 1. Lire les bonnes réponses depuis exercices.contenu.items
    ...
    // 2. Comparer les réponses et construire item_results
    let correctCount = 0;
    ...
    // 3. Insérer dans exercise_attempts
